...
COMPRESS      = gzip -9f
DISTNAME      = test1.0.0
DISTDIR = /home/jmacey/CGAA/Vec3/.tmp/test1.0.0
LINK          = g++
...
moc_predefs.h: /opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++1z -Wall -Wextra -g -g -std=gnu++11 -Wall -W -dM -E -o moc_predefs.h /opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/features/data/dummy.cpp
